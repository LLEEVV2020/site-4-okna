    ...
    <div class="thanky">
        <div class="zoom-gallery" id="zoom-instance-1" style="margin: 0px auto;  height: 397px;">
            ...
            <ul>
                ...
                <li title="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/es16_bg_big-1.png">
                    <ul class="align-left">
                        <li class="10x208"
                            style="background-color: none; color: #464545; font-size:2.4em; line-height:30px; height:auto;">
                            Входные двери. Цена: <span>3100 </span>р.<br />
                ...
                <li title="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/es16_bg_big-2.png">
                    <ul class="align-left">
                        <li class="10x208"
                            style="background-color: none; color: #464545; font-size:2.4em; line-height:30px; height:auto;">
                            Входные двери. Цена: <span>3100 </span>р.<br />
                ...
                <li title="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/es16_bg_big-3.png">
                    <ul class="align-left">
                        <li class="10x208"
                            style="background-color: none; color: #464545; font-size:2.4em; line-height:30px; height:auto;">
                            Входные двери. Цена: <span>3100 </span>р.<br />
