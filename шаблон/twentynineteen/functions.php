...
function display_city(){
  ...
  echo "<div><input placeholder='В Москве и области' type='text' name='my_city_v_o' value='".esc_attr(get_option('my_city_v_o'))."'> <span>В Москве  и области</span> <span><i>es6_doors_3.php (главная)</i> </span></div>";	
