...
<script src="//<?php echo $_SERVER['SERVER_NAME']; ?>/js/jquery-migrate-1.2.1.min.js"></script>
    ...
    <!--logo-->
    <link rel="icon" href="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/cropped-logo1-150x150.png" sizes="32x32">
    <link rel="icon" href="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/cropped-logo1-150x150.png" sizes="192x192">
    <link rel="apple-touch-icon-precomposed" href="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/cropped-logo1-150x150.png">
    <meta name="msapplication-TileImage" content="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/cropped-logo1-150x150.png">
