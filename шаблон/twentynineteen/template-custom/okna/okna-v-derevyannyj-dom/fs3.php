    ...
    <script type="text/javascript">
        stoim1mkv = 3200 ;   //старая стоимость 1 м2
        stoim1mkvnew = 2310;
    ...
    <div class="b-raschet b-raschet-okna">
        <div class="container">
            <div class="h2">БЫСТРЫЙ РАСЧЕТ ОСТЕКЛЕНИЯ ВЕРАНДЫ </div>
            <div class="b-raschet__form ">
                <form>
                    <div class="b-form__block">
                        <div class="b-form__item">
                            <div class="b-form_lbl">Введите<br> 
площадь</div>
                        </div>
                        <div class="b-form__item">
                        ...
                        <div class="b-form__item">
                                <span id="sksksk">3200</span> <span>р</span>
                        </div>
                        <div class="b-form__item">
                            <div class="b-form_newprice">
                                <span id="sksksk-new"> 2310</span> <span >р</span>
                            </div>
                        </div>
                        <div class="b-form__item">
            ...
            <div class="b-raschet__ttl1">Звоните прямо сейчас и получите самое выгодное предложение! <br>
                    <strong>Дешевле нет нигде!</strong>  </div>
        </div>
    </div>
    <!--b-raschet"-->