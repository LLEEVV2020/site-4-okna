    ...
    <div class="top_block__logo" itemscope itemtype="http://webmaster.yandex.ru/vocabularies/term-def.xml">
       	<?php //1 if ( has_custom_logo() ) : ?>
		    <?php 
                ...
                //2 the_custom_logo(); ?>
        <?php //3 else : ?>
            <a href="//<?php echo $_SERVER['SERVER_NAME']; ?>" > <img src="//<?php echo $_SERVER['SERVER_NAME']; ?>/img/logo.png" alt="Пластиковые Окна Цены" /> </a>
            <span> <a style="color: inherit;" href="//<?php echo $_SERVER['SERVER_NAME']; ?>">ПЛАСТИКОВЫЕ 
                        ОКНА ЦЕНЫ</a></span>
            <?php //4 endif; ?>
